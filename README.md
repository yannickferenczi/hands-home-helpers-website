...
## 1. Table of content
  ...
  - [1. Table of content](#11-table-of-content)
  - [2. UX Design](#12-ux-design)
    - [2.1. Strategy Plane](#121-strategy-plane)
      - [2.1.1. Business Plan](#1211-business-plan)
      - [2.1.2. Goals and objectives](#1212-goals-and-objectives)
      - [2.1.3. Target Audience](#1213-target-audience)
        - [2.1.3.1. User Research](#12131-user-research)
        - [2.1.3.2. Buyer Personas](#12132-buyer-personas)
    - [2.2. Scope Plane](#122-scope-plane)
      - [2.2.1. Define Must-Have Features](#1221-define-must-have-features)
      - [2.2.2. Define Information to provide (content requirements)](#1222-define-information-to-provide-content-requirements)
    - [2.3. Structure Plane](#123-structure-plane)
      - [2.3.1. Interaction Design (IXD)](#1231-interaction-design-ixd)
        - [2.3.1.1. Define Pages](#12311-define-pages)
        - [2.3.1.2. Handle errors](#12312-handle-errors)
        - [2.3.1.3. Flow Chart](#12313-flow-chart)
      - [2.3.2. Information Architecture (IA)](#1232-information-architecture-ia)
    - [2.4. Skeleton Plane](#124-skeleton-plane)
      - [2.4.1. Wireframes](#1241-wireframes)
    - [2.5. Surface Plane](#125-surface-plane)
      - [2.5.1. Color Palette](#1251-color-palette)
      - [2.5.2. Font Choices](#1252-font-choices)
    - [2.6. Database Schema](#126-database-schema)
  - [3. Agile Development](#13-agile-development)
    - [3.1. The workflow](#131-the-workflow)
    -   3.2. Labels](#132-labels)
    - [3.3. The views of the project manager](#133-the-views-of-the-project-manager)
    - [3.4. The story points](#134-the-story-points)
    - [3.5. The sprints](#135-the-sprints)
  - [4. Features](#14-features)
    - [4.1. Features currently available](#141-features-currently-available)
    - [4.2. More features to implement](#142-more-features-to-implement)
  - [5. Technology Used](#15-technology-used)
  - [6. Testing](#16-testing)
  - [7. Deployment](#17-deployment)
    - [7.1. Project Creation](#171-project-creation)
    - [7.2. Deployment to Heroku](#172-deployment-to-heroku)
    - [7.3. Local Development](#173-local-development)
  - [8. Credits](#18-credits)
  - [9. Acknowledgements](#19-acknowledgements)
