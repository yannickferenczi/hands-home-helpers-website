...
A database schema has been created before each important part of the development. Some details were developed differently to offer a better user experience.
...
My priority was as expected to develop a minimum viable product (MVP) that corresponds to the expected project from the assessment criteria of the code institute. This milestone has 182 story points which are 45% of the total amount represented with 400 story points.
